export const translations = {
  es: {
    ...
    settings: {
      ...
      resetMessage: '¿Estás seguro de que quieres resetear los datos de la Biblia? La app se recargará automáticamente.',
      resetOptionsTitle: '¿Qué deseas borrar?',
      resetOptionsMessage: 'Selecciona qué datos quieres eliminar:',
      resetOnlyVerses: 'Solo Versículos',
      resetWithNotes: 'Versículos y Notas',
      resetWithBookmarks: 'Versículos y Favoritos',
      resetEverything: 'Todo (Versículos, Notas y Favoritos)',
  ...
  en: {
    ...
    settings: {
      ...
      resetMessage: 'Are you sure you want to reset Bible data? The app will reload automatically.',
      resetOptionsTitle: 'What do you want to delete?',
      resetOptionsMessage: 'Select which data you want to remove:',
      resetOnlyVerses: 'Only Verses',
      resetWithNotes: 'Verses and Notes',
      resetWithBookmarks: 'Verses and Bookmarks',
      resetEverything: 'Everything (Verses, Notes & Bookmarks)',
